...
async function handleRepair(device) {
...
<template>
  <div>
    <div class="mb-6 flex items-center justify-between">
      <h1 class="text-2xl font-semibold text-gray-900">Hardware Management</h1>
      <button
      ...
      <table class="w-full text-left text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
          ...
          <tr v-else-if="devices.length === 0">
            <td colspan="6" class="px-5 py-6 text-center text-gray-400">No devices yet.</td>
          </tr>
            ...
            <td class="px-5 py-3">
              <div class="flex items-center justify-end gap-3 text-gray-400">
                ...
                <button
                  ...
                  :disabled="busyId === device.id || device.status === 'Repair'"
